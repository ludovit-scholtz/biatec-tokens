...
- **Compliance Reporting** (80%): Reporting, saved audience templates, scheduled delivery, approval history, export readiness, regulator-ready audit export packages, release evidence surfaces, and command-center lifecycle states improved materially on `main`; draft PR **#737** extends reporting / audit-export navigation and wiring, but it is still open, and regulator-grade reporting still needs merged delivery, backend promotion, and current protected sign-off evidence
...
- Draft PR **#737** is the next reporting / audit-export milestone, but it is still open and only has Copilot checks so far; it is roadmap progress, not current production evidence.
...
- 🟡 **Reporting / audit-export roadmap work is in flight, not shipped:** draft PR **#737** improves reporting-workspace wiring and tests, but it is not merged or current-head CI-backed yet.
...
- **MEDIUM:** Merge and independently validate the regulator-ready reporting / audit-export milestone in PR **#737**; do not count it as shipped until standard CI and current-head evidence exist.
...
- **Treat draft PR #737 as in-flight roadmap progress, not shipped product:** it strengthens the reporting / audit-export milestone, but it does not count toward business-owner sign-off until merged and backed by current-head CI.
